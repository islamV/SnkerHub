...
export { logo, gif };
let data2; // Declare data2 variable outside of fetch function scope


   
export  const products =  fetch('https://generalapi.test/api/products') // api for the get request
...
export const data = {
  ...
  sneakers: [
    ...
    },
    {
      ...
      product_condition: "new_with_defects",
      silhouette: "Air Jordan 1",
      size_range: [
        10, 10.5, 11, 11.5, 12, 12.5, 13, 13.5, 14, 14.5, 15, 15.5, 16, 16.5,
        17, 17.5, 18, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5,
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Air Jordan 12 Retro ‘Gym Red’ presents a monochromatic take on Tinker Hatfield’s 1996 design. The entirety of the mid-top silhouette is dipped in red, including the rubber tooling and herringbone tread outsole. Contrasting hits of black are used throughout the product’s branding elements and sockliner. While the all-red finish presents a radical new look for the vintage silhouette, the performance benefits remain unchanged, highlighted by full-length Zoom Air that extends from heel to toe.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Air Jordan SB 1 Retro High is representative of the decades-old influence that the iconic product has had on skate culture. Revealed in May 2019, this &#39;Light Bone&#39; update is formed by a classic leather upper treated with a wear-away finish concealing an alternate tint. Custom branding resurfaces via the lateral Swooshes, Jumpman tongue label and Wings logo. The encapsulated Air unit and concentric circle outsole are mainstays on this classic silhouette.",
      upper_material: null,
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "Instead of the usual two-tone color blocking, the Air Jordan 1 Retro High OG ‘Phantom’ makes use of contrast stitching in black and red to distinguish the high-top’s clean lines. The product’s all-leather upper is finished in off-white Sail, accented by a padded collar and underlayer Swoosh in University Red. True to its OG designation, the design is finished with Nike Air branding on the woven tongue tag and insole.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Off-White x Air Max 90 ‘Black’ offers a unique blend of materials on the upper, which combines a ripstop base with nubuck overlays and a suede mudguard. The all-black finish is contrasted by a white Swoosh with zigzag stitching, a small orange tab on the quarter panel and orange stitching on the exposed-foam tongue. Virgil Abloh’s signature text block makes an appearance on the product’s medial side.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Nike Air Force 1 Low is a modern take on the iconic white on white low top Air Force 1. Released in honor of the classic product&#39;s 25th anniversary in 2007, the sneaker features an upgraded, crispier 10A full grain leather white upper with a matching white Air-cushioned rubber sole.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "Created by acclaimed streetwear designer Jerry Lorenzo for release in April 2019, the Air Fear of God Raid &#39;Light Bone&#39; draws inspiration from Lorenzo&#39;s favorite silhouette, the Air Raid outdoor basketball product first introduced in 1992. Incorporating the same distinct cross straps into the Light Bone upper, a contrasting black Swoosh stands out along with the visible double-stacked Zoom Air units. Modern design lines combine with premium comfort to define this lifestyle product.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Vans Old Skool ‘Yacht Club’ showcases bold color blocking inspired by traditional nautical flags. The product’s upper is executed with canvas quarter panels in kelly green, overlaid with a white leather side stripe, and contrasted by a blue suede toe cap and yellow suede heel panel. The multi-color design rests on a crisp white rubber midsole, accented with Vans’ signature ‘Off the Wall’ license plate in red.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "Music and fashion icon Kanye West debuted the Yeezy Boost 700 at his Yeezy Season 5 fashion show in February 2017. This &#39;Analog&#39; colorway released April 2019, and provides a monochromatic look to the acclaimed product. Dressed in shades of off white, the upper features a variety of panels constructed of leather, mesh, suede with a small hit of reflective material near the heel. Full-length Boost cushioning is embedded in the signature chunky midsole while a black rubber outsole provides contrast.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "With its name coming from the colorway similarities found on the first Yeezy Boost 350 V2, the Yeezy Boost 350 V2 &#39;Beluga 2.0&#39; dropped on November 25, 2017. It was quickly restocked on November 30th after selling out. The product features a muted grey stripe on the laterals instead of the bright orange stripe found on the original ‘Beluga’ sneaker. The Yeezy Boost 350 V2 &#39;Beluga 2.0&#39; also features a heel pull tab with orange stitching and orange ‘SPLY-350’ lettering in reverse on the laterals. ",
      upper_material: "Primeknit",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Yeezy Boost 350 V2 ‘Static Non-Reflective’ is designed to stand out, thanks to the addition of never-before-seen features. They include a translucent side stripe and 3M reflective detailing on the product’s rope laces, Primeknit upper and Three-Stripes branding on the interior heel. The midsole makes use of ridged TPU sidewalls with semi-translucent properties, revealing full-length adidas Boost cushioning within.",
      upper_material: "Primeknit",
    },
    {
      box_condition: "badly_damaged",
      ...
      status: "active",
      story_html:
        "Alongside an accompanying Crazy BYW, the Pharrell x Solar Hu Glide ST ‘Chinese New Year’ rings in the Year of the Pig as part of a collaborative CNY Pack. The lifestyle runner features a red and black knitted upper with gold accents and special embroidery on the toe of each product: ‘Hu’ on the right and the Chinese ‘Fu’ symbol on the left. It all sits on a full-length Boost midsole in classic white.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "The adidas Yeezy Boost 350 V2 ‘Clay’ updates the silhouette with a warm palette and semi-translucent, three-tone vent at the side. This ‘Clay’ colorway retains the stand-out features of the original 350 V2 product, first seen in September 2016, including a flexible Primeknit upper and full-length Boost cushioning. This product released March 2019 exclusively in select cities in North America and Latin America.",
      upper_material: "Primeknit",
    },
    {
      box_condition: "no_original_box",
